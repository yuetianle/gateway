...
${OBJECTDIR}/src/vistek_logger.o: src/vistek_logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -Iinclude -I../common/include -I~/sdk/boost_1_56_0 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vistek_logger.o src/vistek_logger.cpp
